...
const TableManagementPage: React.FC = () => {
    ...
    return (
        <div className="flex min-h-screen bg-tk-bg relative font-['Outfit',sans-serif]">
            ...
            <div className="flex-1 p-5 overflow-y-auto min-h-screen transition-all duration-300 ml-[240px] [.sidebar-collapsed_&]:ml-[80px] max-md:!ml-0 max-md:!p-4 max-md:!pt-[72px] bg-[#f7f8fa] rounded-l-[32px] shadow-[-8px_0_24px_rgba(0,0,0,0.12)] dark:bg-tk-bg-surface max-md:rounded-none dark:rounded-none dark:shadow-none">
                {/* Header */}
